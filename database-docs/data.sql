...
("Eiffel Tower", "Iconic iron lattice tower offering breathtaking views of Paris.", "Eiffel Tower img", 1),
("Notre-Dame Cathedral ", "Gothic masterpiece known for its stunning architecture and history.", "img" ,1),
("Louvre Museum", "World-famous art museum housing the Mona Lisa and countless other treasures.", "img",1),
("Big Ben and the Houses of Parliament", "Iconic clock tower and seat of the UK government." , "img",2),
("The British Museum ", "Renowned museum with a vast collection of art and historical artifacts." , "img",2),
("Buckingham Palace", "The official residence of the British monarch and a symbol of British royalty." , "img" ,2),
("Statue of Liberty","Iconic symbol of freedom and a must-visit landmark."  , "img" ,  3),
("Times Square", "Bright, bustling commercial hub famous for its theaters and billboards."  , "img" , 3),
("Central Park", "Enormous urban park offering green spaces, lakes, and various recreational activities."  , "img" ,3),
